...
awk 'NR==FNR{a[$1]=$2;next}{print $0,a[$1] ? a[$1] : "NA"}' ../../../phenotypes/50.txt.csv qcovars2_${i}.txt > qcovars3_${i}.txt #height 
awk 'NR==FNR{a[$1]=$2;next}{print $0,a[$1] ? a[$1] : "NA"}' ../../../phenotypes/23098.txt qcovars3_${i}.txt > qcovars4_${i}.txt #weight 
awk 'NR==FNR{a[$1]=$2;next}{print $0,a[$1] ? a[$1] : "NA"}' ../../../phenotypes/filtered_21001.txt qcovars4_${i}.txt > qcovars5_${i}.txt #BMI
awk 'NR==FNR{a[$1]=$2;next}{print $0,a[$1] ? a[$1] : "NA"}' ../../../phenotypes/filtered_4079.txt qcovars5_${i}.txt > qcovars6_${i}.txt #Diastolic BP
awk 'NR==FNR{a[$1]=$2;next}{print $0,a[$1] ? a[$1] : "NA"}' ../../../phenotypes/filtered_4080.txt qcovars6_${i}.txt > qcovars7_${i}.txt #Systolic BP
