...
awk 'NR==FNR{a[$1]=$2;next}{print $0,a[$1] ? a[$1] : "NA"}' ../../phenotypes/filtered_21001.txt qcovars4.txt > qcovars5.txt #BMI
awk 'NR==FNR{a[$1]=$2;next}{print $0,a[$1] ? a[$1] : "NA"}' ../../phenotypes/filtered_4079.txt qcovars5.txt > qcovars6.txt #Diastolic BP
awk 'NR==FNR{a[$1]=$2;next}{print $0,a[$1] ? a[$1] : "NA"}' ../../phenotypes/filtered_4080.txt qcovars6.txt > qcovars7.txt #Systolic BP
